...
class Im2grid(nn.Module):
    ...
    def forward(self, moving, fixed):
        ...
        w=self.cotr2(q2, k2)
        w = self.dfi2(w)
        # flow = self.transformer[0](self.upsample_trilin(2 * flow), w) + w
